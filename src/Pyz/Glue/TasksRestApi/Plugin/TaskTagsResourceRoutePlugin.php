...
class TaskTagsResourceRoutePlugin extends AbstractPlugin implements ResourceRoutePluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        return RestTaskTagAttributesTransfer::class;
    }
}
